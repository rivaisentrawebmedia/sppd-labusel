...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
			...
			{
				text: `Dengan ini kami mengajukan orang untuk mengadakan Permohonan Duplikat Kelahiran seperti tersebut di bawah ini :`,
				fontSize: 10,
				margin: [0, 0, 0, 5],
			},
			// 4️⃣ Table
			[
				{
					table: {
						...
						body: [
							...
							[
								{ text: "Jenis Kelamin / Agama", fontSize: 10 },
								{
									text: `: ${
										surat?.jenis_kelamin_anak === "L"
											? "Laki-laki"
											: surat?.jenis_kelamin_anak === "P"
											? "Perempuan"
											: ""
									} / ${surat?.agama_anak || ""}`,
									fontSize: 10,
							...
							[
								...
								{ text: `: ${surat?.alamat_anak || ""}`, fontSize: 10 },
							],
						],
					},
					layout: "noBorders",
			...
			[
				{
					table: {
						...
						body: [
							[
								{ text: "Hari, Tanggal, Pukul", fontSize: 10 },
								{
									text: `: ${
			...
			[
				{
					table: {
						...
						body: [
							...
							[
								{ text: "NIK / Tanggal Lahir Ibu", fontSize: 10 },
								{
									text: `: ${surat?.nik_ibu} / ${
										surat?.tanggal_lahir_ibu
											? dayjs(surat?.tanggal_lahir_ibu)
													.locale("id")
													.format("DD MMMM YYYY")
											: ""
									}`,
							...
							[
								{ text: "Pekerjaan Ibu", fontSize: 10 },
								{
									text: `: ${surat?.pekerjaan_ibu || ""}`,
									fontSize: 10,
								},
							],
							[
								{ text: "Alamat Ibu", fontSize: 10 },
								{
									text: `: ${surat?.alamat_ibu || ""}`,
									fontSize: 10,
								},
							],
						],
					...
					table: {
						...
						body: [
							[
								...
								{
									text: `: ${surat?.nama_ayah || ""}`,
									fontSize: 10,
								},
							],
							[
								{ text: "NIK / Tanggal Lahir Ayah", fontSize: 10 },
								{
									text: `: ${surat?.nik_ayah} / ${
										surat?.tanggal_lahir_ayah
											? dayjs(surat?.tanggal_lahir_ayah)
													.locale("id")
													.format("DD MMMM YYYY")
											: ""
									}`,
							...
							[
								{ text: "Pekerjaan Ayah", fontSize: 10 },
								{
									text: `: ${surat?.pekerjaan_ayah || ""}`,
									fontSize: 10,
								},
							],
							[
								{ text: "Alamat Ayah", fontSize: 10 },
								{
									text: `: ${surat?.alamat_ayah || ""}`,
									fontSize: 10,
								},
							],
						],
			...
			{
				text: `Demikian surat keterangan ini dibuat dengan sebenarnya, atas perhatian dan terkabulnya diucapkan terima kasih.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
