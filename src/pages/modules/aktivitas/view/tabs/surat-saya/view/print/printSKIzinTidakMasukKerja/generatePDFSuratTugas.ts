...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
			...
			// ✅ Paragraf keterangan keperluan
			{
				text: `Adalah benar warga ${profilDesa?.nama_organisasi} Kecamatan ${profilDesa?.Kecamatan} Kabupaten ${profilDesa?.Kabupaten} dan surat keterangan ini diberikan ${surat?.keperluan} di tempat kerja yang bersangkutan:`,
				fontSize: 10,
				margin: [0, 0, 0, 10],
			},
				...
				table: {
					...
					body: [
						...
						[
							...
							{ text: `: ${surat?.jabatan}`, fontSize: 10 },
						],
						[
							{ text: "Lama Izin", fontSize: 10 },
							{ text: `: ${surat?.lama} hari`, fontSize: 10 },
						],
						[
							{ text: "Terhitung dari Tanggal", fontSize: 10 },
							{
								text: `: ${dayjs(surat?.terhitung_dari)
									.locale("id")
									.format("DD MMMM YYYY")}`,
								fontSize: 10,
							},
						...
						[
							{ text: "Alasan Izin", fontSize: 10 },
							{ text: `: ${surat?.alasan_izin}`, fontSize: 10 },
						],
					],
				},
				layout: "noBorders",
			...
			// ✅ Paragraf penutup
			{
				text: `Demikian Surat Keterangan Izin Tidak Masuk Kerja ini dibuat dan diberikan kepada yang bersangkutan untuk dipergunakan sebagaimana mestinya.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
