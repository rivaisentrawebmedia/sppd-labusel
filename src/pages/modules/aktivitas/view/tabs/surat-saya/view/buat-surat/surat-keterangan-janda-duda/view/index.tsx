...
import { FormInformasiJandaDuda } from "./FormInformasiJandaDuda";

export function FormSuratKeteranganJandaDuda() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormInformasiJandaDuda disabled={disabled} form={form} />
