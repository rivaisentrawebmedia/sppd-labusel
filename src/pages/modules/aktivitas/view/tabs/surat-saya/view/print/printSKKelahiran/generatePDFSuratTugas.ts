...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
				...
				},
				{
					table: {
						...
						body: [
							...
							[
								{ text: "Tanggal Lahir", fontSize: 10 },
								{
									text: `: ${
										surat?.tanggal_lahir
							...
							[
								{ text: "Tempat Lahir", fontSize: 10 },
								{ text: `: ${surat?.tempat_lahir || ""}`, fontSize: 10 },
							],
							[
								{ text: "Anak Ke-", fontSize: 10 },
								{ text: `: ${surat?.anak_ke || ""}`, fontSize: 10 },
							],
						],
					},
					layout: "noBorders",
					...
					table: {
						...
						body: [
							...
							[
								...
								{ text: `: ${surat?.alamat_ayah || ""}`, fontSize: 10 },
							],
						],
					},
					layout: "noBorders",
				...
				},
				{
					table: {
						...
						body: [
							...
							[
								{ text: "Alamat Lengkap", fontSize: 10 },
								{ text: `: ${surat?.alamat_ibu || ""}`, fontSize: 10 },
							],
						],
					},
					layout: "noBorders",
			...
			{
				text: `Surat Keterangan Kelahiran ini diberikan ${surat?.keperluan}`,
				fontSize: 10,
				margin: [0, 0, 0, 10],
			},
			{
				text: `Demikian Surat Keterangan Kelahiran ini dibuat dan diberikan kepada yang bersangkutan untuk dipergunakan sebagaimana mestinya.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
