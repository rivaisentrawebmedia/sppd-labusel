...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
					...
					table: {
						...
						body: [
							[
								...
								{ text: `: ${surat?.nama_pejabat || ""}`, fontSize: 10 },
							],
							[
			...
			{
				text: [
					"Adalah benar-benar penduduk ",
					{ text: profil_desa?.nama_organisasi || "", bold: true },
					", yang memiliki/menguasai tanah/lahan berupa ",
					{ text: surat?.jenis_tanah || "", bold: true },
					" atas nama ",
					{ text: surat?.atas_nama || "", bold: true },
					", yang berada di ",
					{ text: profil_desa?.nama_organisasi || "", bold: true },
					". Tercatat dalam ",
					{ text: surat?.bukti_kepemilikan_tanah || "", bold: true },
					", Nomor : ",
					{ text: surat?.nomor_bukti_kepemilikan || "", bold: true },
					", Luas : ",
					{ text: surat?.luas_tanah?.toString() || "", bold: true },
					" m",
			...
			{
				ol: [
					"Tanah tersebut benar-benar MILIK yang bersangkutan dan tidak dalam keadaan sengketa.",
					`Tanah tersebut berasal dari ${surat?.asal_kepemilikan_tanah} dan sampai dengan sekarang belum terdaftar / didaftarkan Hak nya ke BPN (belum diterbitkan : SIIM / SIIGB / SIIGU / LAINNYA).`,
					`Bukti pendukung kepemilikan sementara ini berupa ${surat?.bukti_kepemilikan_tanah_tanah}.`,
				],
				fontSize: 10,
				margin: [10, 0, 0, 5],
			},
