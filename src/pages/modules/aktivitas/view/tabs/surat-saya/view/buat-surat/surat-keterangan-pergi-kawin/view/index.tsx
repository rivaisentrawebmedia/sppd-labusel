...
import { FormInformasiPerkawinan } from "./FormInformasiPerkawinan";

export function FormSuratKeteranganPergiKawin() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormInformasiPerkawinan disabled={disabled} form={form} />
