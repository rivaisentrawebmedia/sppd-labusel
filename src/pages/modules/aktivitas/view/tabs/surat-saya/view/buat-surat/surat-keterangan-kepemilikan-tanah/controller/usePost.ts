...
export function usePostSurat() {
	...
	const onSubmitSurat = async () => {
		...
		const payload: SuratPayload = {
			...
			asal_kepemilikan_tanah: values?.asal_kepemilikan_tanah,
			...
			bukti_kepemilikan_tanah: values?.bukti_kepemilikan_tanah,
			bukti_kepemilikan_tanah_tanah: values?.bukti_kepemilikan_tanah_tanah,
			jenis_tanah: values?.jenis_kelamin,
			luas_tanah: values?.luas_tanah,
			nomor_bukti_kepemilikan: values?.nomor_bukti_kepemilikan,
		};
