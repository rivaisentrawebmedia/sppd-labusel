...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
			...
			// ✅ Paragraf Penjelas
			{
				text: `Adalah benar warga ${profilDesa?.nama_organisasi} Kecamatan ${profilDesa?.Kecamatan} Kabupaten ${profilDesa?.Kabupaten} dan memiliki identitas sebagaimana yang diterangkan di atas.`,
				fontSize: 10,
				margin: [0, 0, 0, 10],
			},
			...
			// ✅ Paragraf Keperluan
			{
				text: `Surat Keterangan Resi KTP Sementara ini diberikan ${surat?.keperluan}`,
				fontSize: 10,
				margin: [0, 0, 0, 10],
			},
			...
			// ✅ Paragraf Penutup
			{
				text: `Demikian Surat Keterangan Resi KTP Sementara ini dibuat dan diberikan kepada yang bersangkutan untuk dipergunakan sebagaimana mestinya.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
