...
export function FormInformasiAyahSuami({
	disabled,
	form,
}: {
		...
		<>
			<div className="flex flex-col gap-4  border shadow  bg-white rounded-md p-4">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
					...
					<SelectInput
						form={form}
						name="kewarganegaraan_ayah_suami"
						isDisabled={disabled}
						isRequired
						isRow
					...
					<TextInput
						form={form}
						name="nama_organisasi_ayah_suami"
						isDisabled={disabled}
						isRow
