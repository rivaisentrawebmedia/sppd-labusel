...
export const ResolverSurat = z.object({
	...
	berlaku_dari: z.string({ message: "Berlaku dari wajib diisi" }),
	berlaku_sampai: z.string({ message: "Berlaku sampai wajib diisi" }),
	no_kartu: z.string({ message: "No kartu wajib diisi" }),
