...
import { FormPemberiKuasa } from "./FormPemberiKuasa";
import { FormPenerimaKuasa } from "./FormPenerimaKuasa";

export function FormSuratKuasa() {
	...
	return (
		<>
			<Form {...form}>
				...
				>
					<FormPemberiKuasa disabled={disabled} form={form} />
					<FormPenerimaKuasa disabled={disabled} form={form} />
