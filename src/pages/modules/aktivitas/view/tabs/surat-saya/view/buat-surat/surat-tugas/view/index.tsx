...
import { FormInformasiTugas } from "./FormInformasiTugas";
import { FormWargaDesa } from "../../FormWargaDesa";
import { FormInformasiPenerima } from "./FormInformasiPenerima";
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormInformasiPenerima isLoading={disabled} form={form} />
					<FormInformasiTugas disabled={disabled} form={form} />
