...
import { FormInformasiBedaIdentitas } from "./FormBedaIdentitas";

export function FormSuratKeteranganBedaIdentitas() {
	...
	return (
		<>
			<Form {...form}>
				...
				>
					<FormInformasiBedaIdentitas disabled={disabled} form={form} />
