...
import { FormInformasiAyah } from "./FormInformasiAyah";
import { FormInformasiIbu } from "./FormInformasiIbu";

export function FormSuratPermohonanDuplikatKelahiran() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormInformasiAnak disabled={disabled} form={form} />
					<FormInformasiAyah disabled={disabled} form={form} />
					<FormInformasiIbu disabled={disabled} form={form} />
