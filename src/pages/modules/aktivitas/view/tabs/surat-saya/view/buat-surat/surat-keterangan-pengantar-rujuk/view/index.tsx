...
import { FormInformasiPasangan } from "./FormInformasiPasangan";

export function FormSuratKeteranganPengantarCerai() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormInformasiPasangan disabled={disabled} form={form} />
