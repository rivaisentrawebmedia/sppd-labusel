	...
	return {
		content: [
			...
			[
					...
					table: {
						...
						body: [
							[
								...
								{ text: `: ${surat?.nik_1 || ""}`, fontSize: 10 },
							],
							[
								{ text: "Nama", fontSize: 10 },
								{ text: `: ${surat?.nama_1 || ""}`, fontSize: 10 },
							],
							[
								{ text: "Tempat, Tanggal Lahir", fontSize: 10 },
								{
									text: `: ${surat?.tempat_lahir_1 || ""}, ${
										surat?.tanggal_lahir_1
											? dayjs(surat?.tanggal_lahir_1)
													.locale("id")
													.format("DD MMMM YYYY")
											: ""
									}`,
							...
							[
								...
								{
									text: `: ${
										surat?.jenis_kelamin_1 === "L"
											? "Laki-laki"
											: surat?.jenis_kelamin_1 === "P"
											? "Perempuan"
											: ""
									}`,
									fontSize: 10,
							...
							[
								...
								{ text: `: ${surat?.pekerjaan_1 || ""}`, fontSize: 10 },
							],
							[
								{ text: "Alamat Lengkap", fontSize: 10 },
								{ text: `: ${surat?.alamat_1 || ""}`, fontSize: 10 },
							],
						],
					},
					layout: "noBorders",
				...
				// 3️⃣ Judul Data Ibu
				{
					text: `Yang bersangkutan hendak menjual ${surat?.jenis_barang}. ${surat?.jenis_barang} tersebut tidak dalam sengketa dengan pihak lain sehingga dapat dijual kepada pihak kedua yaitu:`,
					margin: [0, 0, 0, 5],
					fontSize: 10,
				},
				{
					table: {
						...
						body: [
							...
							[
								...
								{
									text: `: ${
										surat?.jenis_kelamin_2 === "L"
											? "Laki-laki"
											: surat?.jenis_kelamin_2 === "P"
											? "Perempuan"
											: ""
									}`,
									fontSize: 10,
			...
			{
				text: `Demikian surat ini dibuat dengan sesungguhnya agar dapat dipergunakan sebagaimana mestinya.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
