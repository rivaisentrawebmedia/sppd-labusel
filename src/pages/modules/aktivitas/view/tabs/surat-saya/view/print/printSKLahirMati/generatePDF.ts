...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
					...
					table: {
						...
						body: [
							...
							[
								...
								{ text: `: ${surat?.agama_ibu || ""}`, fontSize: 10 },
							],

							[
								{ text: "Pekerjaan", fontSize: 10 },
								{ text: `: ${surat?.pekerjaan_ibu || ""}`, fontSize: 10 },
							],
							[
								{ text: "Kewarganegaraan", fontSize: 10 },
								{
									text: `: ${
										surat?.kewarganegaraan_ibu_id?.toUpperCase() || ""
									}`,
									fontSize: 10,
								},
							],
			...
			{
				text: `Telah lahir bayi dalam keadaan mati, setelah dikandungannya selama ${surat?.lama_dikandung} bulan:`,
				fontSize: 10,
				margin: [0, 0, 0, 5],
			},
			[
				{
					table: {
						...
						body: [
							[
								{ text: "Pada hari, tanggal", fontSize: 10 },
								{
									text: `: ${
			...
			{
				text: `Surat keterangan ini dibuat berdasarkan keterangan pelapor:`,
				fontSize: 10,
				margin: [0, 0, 0, 5],
			},
					...
					table: {
						...
						body: [
							...
							[
								...
								{ text: `: ${surat?.hubungan_id || ""}`, fontSize: 10 },
							],
						],
					},
					layout: "noBorders",
