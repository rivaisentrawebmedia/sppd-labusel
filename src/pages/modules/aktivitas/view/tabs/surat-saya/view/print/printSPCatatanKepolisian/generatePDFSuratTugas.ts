...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
			...
			{
				text: `Adalah benar warga ${profilDesa?.nama_organisasi} Kecamatan ${profilDesa?.Kecamatan} Kabupaten ${profilDesa?.Kabupaten} dan berdasarkan keterangan yang tercatat di desa, bahwa yang bersangkutan:`,
				margin: [0, 0, 0, 10],
				fontSize: 10,
				alignment: "justify",
			},
			{
				ol: [
					"Berkelakuan baik",
					"Tidak pernah tercatat dalam kegiatan/tindak kriminal",
					"Tidak pernah terlibat ke dalam organisasi yang dilarang oleh hukum",
				],
				margin: [30, 0, 0, 10],
				fontSize: 10,
			},
			{
				text: `Surat Pengantar Catatan Kepolisian ini diberikan ${surat?.keperluan}.`,
				margin: [0, 0, 0, 10],
				fontSize: 10,
				alignment: "justify",
			},
			{
				text: `Demikian Surat Pengantar Catatan Kepolisian ini dibuat dan diberikan kepada yang bersangkutan untuk dipergunakan sebagaimana mestinya.`,
				margin: [0, 0, 0, 20],
				fontSize: 10,
				alignment: "justify",
			},
