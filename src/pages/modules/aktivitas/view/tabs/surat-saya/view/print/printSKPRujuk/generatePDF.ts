					...
					table: {
						...
						body: [
							[
								...
								{ text: `: ${surat?.nama_pasangan || ""}`, fontSize: 10 },
							],
							[
								{ text: "Binti", fontSize: 10 },
								{ text: `: ${surat?.nama_ayah_pasangan || ""}`, fontSize: 10 },
							],
							[
								{ text: "Tempat, Tanggal Lahir", fontSize: 10 },
								{
									text: `: ${surat?.tempat_lahir_pasangan || ""}, ${
										surat?.tanggal_lahir_pasangan
											? dayjs(surat?.tanggal_lahir_pasangan)
													.locale("id")
													.format("DD MMMM YYYY")
											: ""
									}`,
							...
							[
								...
								{
									text: `: ${
										surat?.kewarganegaraan_pasangan?.toUpperCase() || ""
									}`,
									fontSize: 10,
								},
							],
							[
								{ text: "Agama", fontSize: 10 },
								{ text: `: ${surat?.agama_pasangan || ""}`, fontSize: 10 },
							],
							[
								{ text: "Pekerjaan", fontSize: 10 },
								{ text: `: ${surat?.pekerjaan_pasangan || ""}`, fontSize: 10 },
							],

							[
								{ text: "Alamat/Tempat Tinggal", fontSize: 10 },
								{ text: `: ${surat?.alamat_pasangan || ""}`, fontSize: 10 },
							],
						],
					},
					layout: "noBorders",
