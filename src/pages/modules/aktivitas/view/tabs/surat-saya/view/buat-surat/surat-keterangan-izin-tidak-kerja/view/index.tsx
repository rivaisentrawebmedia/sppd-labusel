...
import { FormInformasiIzinTidakMasuk } from "./FormInformasiIzinTidakMasuk";
import { FormWargaDesa } from "../../FormWargaDesa";
import { FormInformasiTambahan } from "../../FormInformasiTambahan";

export function FormSuratKeteranganIzinTidakMasukKerja() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormInformasiIzinTidakMasuk disabled={disabled} form={form} />
