...
import { FormPindahDomisili } from "./FormInformasiPindahDomisili";

export function FormSuratPengantarPindahDomisili() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormPindahDomisili disabled={disabled} form={form} />
