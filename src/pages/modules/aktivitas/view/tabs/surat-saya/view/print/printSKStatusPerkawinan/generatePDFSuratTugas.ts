...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
			...
			// ✅ Paragraf status
			{
				text: `Adalah benar warga ${profilDesa?.nama_organisasi} Kecamatan ${profilDesa?.Kecamatan} Kabupaten ${profilDesa?.Kabupaten} dan berdasarkan data kependudukan yang ada di desa hingga ditulisnya surat keterangan ini, benar adanya bahwa status perkawinan yang bersangkutan adalah :`,
				fontSize: 10,
				margin: [0, 0, 0, 10],
			},

			// ✅ Status Perkawinan (center, bold)
			{
				text: "KAWIN",
				bold: true,
				alignment: "center",
			...
			// ✅ Penutup
			{
				text: `Surat Keterangan Status Perkawinan ini diberikan ${surat?.keperluan}`,
				fontSize: 10,
				margin: [0, 0, 0, 10],
			},
			{
				text: `Demikian Surat Keterangan Status Perkawinan ini dibuat dan diberikan kepada yang bersangkutan untuk dipergunakan sebagaimana mestinya.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
