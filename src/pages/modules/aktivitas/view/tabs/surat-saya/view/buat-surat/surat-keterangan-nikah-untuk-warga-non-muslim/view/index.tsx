...
import { FormInformasiSuami } from "./FormInformasiSuami";
import { FormInformasiIstriTerdahulu } from "./FormIstriTerdahulu";
import { MoveLeft, MoveRight } from "lucide-react";
import { FormInformasiAyahSuami } from "./FormInformasiAyahSuami";
import { FormInformasiIbuSuami } from "./FormInformasiIbuSuami";
import { FormInformasiSuamiTerdahulu } from "./FormSuamiTerdahulu";
import { FormInformasiAyahIstri } from "./FormInformasiAyahIstri";
import { FormInformasiIbuIstri } from "./FormInformasiIbuIstri";
import { FormInformasiSaksi1 } from "./FormSaksi1";
import { FormInformasiSaksi2 } from "./FormSaksi2";
import { FormInformasiPernikahan } from "./FormInformasiPernikahan";
import { FormInformasiAnak } from "./FormInformasiAnak";
import { FormInformasiIstri } from "./FormInformasiIstri";

export function FormSuratKeteranganNikahWargaNonMuslim() {
	...
	const listMenu = [
		"Informasi Suami",
		"Informasi Orang Tua Suami",
		"Informasi Istri",
		"Informasi Orang Tua Istri",
		"Informasi Saksi",
	...
	const konten = () => {
		switch (menu) {
			case listMenu?.[0]:
				return (
					<div className="flex flex-col gap-4 w-full ">
						<FormInformasiSuami form={form} disabled={disabled} />
						<FormInformasiIstriTerdahulu form={form} disabled={disabled} />
			...
			case listMenu?.[2]:
				return (
					<div className="flex flex-col gap-4 w-full ">
						<FormInformasiIstri form={form} disabled={disabled} />
						<FormInformasiSuamiTerdahulu form={form} disabled={disabled} />
						<div className="flex items-center justify-end gap-3">
							<button
								type="button"
								onClick={() => {
			...
			case listMenu?.[4]:
				return (
					<div className="flex flex-col gap-4 w-full ">
						<FormInformasiSaksi1 form={form} disabled={disabled} />
						<FormInformasiSaksi2 form={form} disabled={disabled} />
						<div className="flex items-center justify-end gap-3">
							<button
								type="button"
								onClick={() => {
			...
			case listMenu?.[5]:
				return (
					<div className="flex flex-col gap-4 w-full ">
						...
						<FormInformasiAnak form={form} isLoading={disabled} />
