...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
			...
			[
				{
					table: {
						...
						body: [
							...
							[
								{ text: "Keperluan", fontSize: 10 },
								{ text: `: ${surat?.keperluan || ""}`, fontSize: 10 },
							],
						],
					},
					layout: "noBorders",
			...
			// 3️⃣ Judul Data Ibu
			{
				text: `Orang tersebut di atas adalah benar-benar warga ${profil_desa?.nama_organisasi} dengan data seperti di atas, dari keluarga kurang mampu pemegang Kartu Peserta Jamkesos No. ${surat?.no_kartu}.`,
				margin: [0, 0, 0, 5],
				fontSize: 10,
			},
			{
