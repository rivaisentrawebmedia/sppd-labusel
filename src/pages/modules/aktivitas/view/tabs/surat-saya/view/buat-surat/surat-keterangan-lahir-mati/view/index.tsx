...
import { FormInformasiKelahiran } from "./FormInformasiKelahiran";

export function FormSuratKeteranganLahirMati() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormInformasiKelahiran disabled={disabled} form={form} />
