...
import { FormInformasiBarangHilang } from "./FormInformasiKehilangan";

export function FormSuratPengantarKehilangan() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormInformasiBarangHilang disabled={disabled} form={form} />
