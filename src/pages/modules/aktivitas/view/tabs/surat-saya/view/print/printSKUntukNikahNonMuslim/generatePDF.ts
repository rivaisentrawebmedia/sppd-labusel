...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
					...
					table: {
						...
						body: [
							[
								...
								{ text: `: ${surat?.nama_suami || ""}`, fontSize: 10 },
							],
							[
								{ text: "Tempat, Tanggal Lahir", fontSize: 10 },
								{
									text: `: ${surat?.tempat_lahir_suami || ""}, ${
										surat?.tanggal_lahir_suami
											? dayjs(surat?.tanggal_lahir_suami)
													.locale("id")
													.format("DD MMMM YYYY")
											: ""
									}`,
							...
							[
								{ text: "No. KTP", fontSize: 10 },
								{ text: `: ${surat?.nik_suami || ""}`, fontSize: 10 },
							],
							[
								{ text: "No. KK", fontSize: 10 },
								{ text: `: ${surat?.no_kk_suami || ""}`, fontSize: 10 },
							],
							[
								{ text: "Warga Negara", fontSize: 10 },
								{
									text: `: ${
										surat?.kewarganegaraan_suami?.toUpperCase() === "WNI"
											? "WNI"
											: surat?.warga_negara_suami
									}`,
									fontSize: 10,
								},
							],
							...
							[
								...
								{ text: `: ${surat?.agama_suami || ""}`, fontSize: 10 },
							],
							[
								{ text: "Pekerjaan", fontSize: 10 },
								{ text: `: ${surat?.pekerjaan_suami || ""}`, fontSize: 10 },
							],
							[
								{ text: "Alamat/Tempat Tinggal", fontSize: 10 },
								{ text: `: ${surat?.alamat_suami || ""}`, fontSize: 10 },
							],
						],
					},
					layout: "noBorders",
			...
			{
				text: `Nama tersebut di atas betul telah menikah dengan seorang perempuan yang bernama:`,
				fontSize: 10,
				margin: [0, 0, 0, 5],
			},
			// 4️⃣ Table
			[
				{
					table: {
						...
						body: [
							[
								{ text: "Nama Lengkap", fontSize: 10 },
								{ text: `: ${surat?.nama_istri || ""}`, fontSize: 10 },
							],
							[
								{ text: "Tempat, Tanggal Lahir", fontSize: 10 },
								{
									text: `: ${surat?.tempat_lahir_istri || ""}, ${
										surat?.tanggal_lahir_istri
											? dayjs(surat?.tanggal_lahir_istri)
													.locale("id")
													.format("DD MMMM YYYY")
											: ""
									}`,
							...
							[
								{ text: "No. KTP", fontSize: 10 },
								{ text: `: ${surat?.nik_istri || ""}`, fontSize: 10 },
							],
							[
								{ text: "No. KK", fontSize: 10 },
								{ text: `: ${surat?.no_kk_istri || ""}`, fontSize: 10 },
							],
							[
								{ text: "Warga Negara", fontSize: 10 },
								{
									text: `: ${
										surat?.kewarganegaraan_istri?.toUpperCase() === "WNI"
											? "WNI"
											: surat?.warga_negara_istri
									}`,
									fontSize: 10,
								},
							],
							...
							[
								{ text: "Agama", fontSize: 10 },
								{ text: `: ${surat?.agama_istri || ""}`, fontSize: 10 },
							],
							[
								{ text: "Pekerjaan", fontSize: 10 },
								{ text: `: ${surat?.pekerjaan_istri || ""}`, fontSize: 10 },
							],
							[
								{ text: "Alamat/Tempat Tinggal", fontSize: 10 },
								{ text: `: ${surat?.alamat_istri || ""}`, fontSize: 10 },
							],
						],
					},
					layout: "noBorders",
			...
			{
				text: `Demikian Surat ini dibuat, untuk dipergunakan sebagaimana mestinya.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
