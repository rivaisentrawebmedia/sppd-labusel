...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
			...
			[
				{
					table: {
						...
						body: [
							...
							[
								{ text: "Kepala Keluarga", fontSize: 10 },
			...
			{
				text: `Yang namanya tersebut di atas memang benar warga kami dan telah menikah di KUA ${
					surat?.kecamatan_kua
				} pada ${dayjs(surat?.tanggal_nikah)
					.locale("id")
					.format("DD MMMM YYYY")} dengan seseorang yang bernama ${
					surat?.nama_pasangan
				}. Berdasarkan data di atas mohon untuk dibuatkan Duplikat Surat Nikah orang tersebut di atas.`,
				fontSize: 10,
				margin: [0, 0, 0, 5],
			},
			{
				text: `Demikian surat permohonan duplikat surat nikah ini dibuat dengan sebenarnya, untuk dipergunakan sebagaimana mestinya.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
