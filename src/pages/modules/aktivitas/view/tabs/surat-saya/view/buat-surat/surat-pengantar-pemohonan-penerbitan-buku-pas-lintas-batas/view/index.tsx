...
import { FormInformasiAnggotaKK } from "./FormInformasiAnggotaKK";

export function FormSuratPengantarPermohonanPenerbitanBukuPasLintas() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormInformasiAnggotaKK isLoading={disabled} form={form} />
