...
import { FormInformasiPerubahanKK } from "./FormInformasiPerubahanKK";

export function FormSuratPermohonanPerubahanKK() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormInformasiPerubahanKK disabled={disabled} form={form} />
