...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
			...
			{
				columns: [
					{ width: "50%", text: "" }, // Kolom kiri kosong
					{
						width: "50%",
						text: `Kepada Yth. Kepala Pengadilan Agama Kabupaten ${profil_desa?.Kabupaten}`,
						fontSize: 10,
						alignment: "left", // Rata kiri dalam kolom kanan
						margin: [0, 0, 0, 20],
					},
				],
			},
			...
			{
				text: `Dengan ini kami kirimkan dengan hormat permohonan cerai dari pasangan suami istri:`,
				fontSize: 10,
				margin: [0, 0, 0, 5],
			},
			{
					...
					table: {
						...
						body: [
							...
							[
								...
								{ text: `: ${surat?.agama_id_suami || ""}`, fontSize: 10 },
							],
							[
			...
			[
				{
					table: {
						...
						body: [
							...
							[
								{ text: "Agama", fontSize: 10 },
								{ text: `: ${surat?.agama_id_istri || ""}`, fontSize: 10 },
							],
							[
								{ text: "Alamat/Tempat Tinggal", fontSize: 10 },
			...
			{
				text: `Adapun sebab-sebab menurut keterangannya sebagai berikut : `,
				fontSize: 10,
				margin: [0, 0, 0, 5],
			},
			{
				text: `${surat?.sebab_cerai} `,
				fontSize: 10,
				margin: [0, 0, 0, 5],
			},
			{
