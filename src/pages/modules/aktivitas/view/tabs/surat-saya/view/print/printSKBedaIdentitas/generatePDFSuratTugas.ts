...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
			...
			{
				text: `Data yang tercantum di ${surat?.tercantum}:`,
				margin: [0, 0, 0, 5],
				fontSize: 10,
			},
			{
			...
			{
				text: `Data yang tercantum di ${surat?.tercantum_2}:`,
				margin: [0, 0, 0, 5],
				fontSize: 10,
			},
			{
			...
			{
				text: `Adalah benar warga ${profilDesa?.nama_organisasi} Kecamatan ${profilDesa?.Kecamatan} Kabupaten ${profilDesa?.Kabupaten} dan berdasarkan keterangan, identitas yang bersangkutan terdapat perbedaan di penulisan ${surat?.perbedaan_id} pada ${surat?.tercantum} dengan ${surat?.tercantum_2}:`,
				margin: [0, 0, 0, 10],
				fontSize: 10,
				alignment: "justify",
			},
			{
				text: `Perbedaan data tersebut menunjukkan satu orang yang sama dan data yang benar adalah yang tercantum pada ${surat?.tercantum}.`,
				margin: [0, 0, 0, 10],
				fontSize: 10,
				alignment: "justify",
			},
			{
				text: `Surat Keterangan Beda Identitas ini diberikan ${surat?.keperluan}.`,
				margin: [0, 0, 0, 10],
				fontSize: 10,
				alignment: "justify",
			},
			{
				text: `Demikian Surat Keterangan Beda Identitas ini dibuat dan diberikan kepada yang bersangkutan untuk dipergunakan sebagaimana mestinya.`,
				margin: [0, 0, 0, 20],
				fontSize: 10,
				alignment: "justify",
			},
