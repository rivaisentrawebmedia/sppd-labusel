...
import { FormInformasiKendaraan } from "./FormInformasiKendaraan";

export function FormSuratKeteranganKepemilikanKendaraan() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormInformasiKendaraan disabled={disabled} form={form} />
