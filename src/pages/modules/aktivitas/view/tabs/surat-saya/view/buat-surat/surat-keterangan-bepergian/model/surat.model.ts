...
export const ResolverSurat = z.object({
	...
	tempat_tujuan: z.string({ message: "Tempat tujuan wajib diisi" }),
	maksud_tujuan: z.string({ message: "Maksud tujuan wajib diisi" }),
	lama: z.string({ message: "Lama wajib diisi" }),
	satuan_lama: z.string({ message: "Satuan lama wajib diisi" }),
	tanggal_keberangkatan: z.string({
		message: "Tanggal keberangkatan wajib diisi",
	}), // ISO date string (yyyy-mm-dd)
	jumlah_pengikut: z.string({ message: "Jumlah pengikut wajib diisi" }),
