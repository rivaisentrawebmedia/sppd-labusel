	...
	return {
		content: [
			...
			[
				{
					table: {
						...
						body: [
							[
								{ text: "Nomor Induk Kependudukan", fontSize: 10 },
								{ text: `: ${surat?.nik || ""}`, fontSize: 10 },
							],
							[
								{ text: "Nama Lengkap Pemohon", fontSize: 10 },
							...
							[
								{ text: "Status Perkawinan", fontSize: 10 },
								{ text: `: ${surat?.status_kawin || ""}`, fontSize: 10 },
							],
							...
							[
								{ text: "Pengikut Anggota Keluarga", fontSize: 10 },
								{ text: `:`, fontSize: 10 },
							],
						],
					},
			...
			],
			{
				table: {
					headerRows: 1,
					widths: ["3%", "15%", "*", "5%", "10%", "15%", "22%"],
					body: [
						// ✅ Baris Header (7 kolom sesuai widths)
						[
							...
							{ text: "Hubungan", style: "tableHeader" },
							{ text: "Keterangan", style: "tableHeader" },
						],
						// 🔁 Data Baris Anggota Keluarga
						...(Array.isArray(surat?.anggota_keluarga)
							? surat.anggota_keluarga
							: []
						).map((item, i) => [
							{ text: `${i + 1}` },
							{ text: item?.nik },
							...
							{ text: convertFromSnakeCase(item?.hubungan || "") },
							{ text: item?.keterangan }, // Keterangan bisa diisi jika ada
						]),
					],
				},
				layout: {
			...
			{
				text: `Surat pengantar permohonan ini dipergunakan untuk pengurusan penerbitan Buku Pas Lintas Batas.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
						...
						stack: [
							{
								...
								alignment: "center",
								fontSize: 10,
								margin: [0, 0, 0, 40], // spasi tanda tangan
							},
							{
								text: `............................`,
								fontSize: 10,
