			...
			[
				{
					table: {
						...
						body: [
							...
							[
								{ text: "Tujuan", fontSize: 10 },
								{ text: `: ${surat?.tujuan || ""}`, fontSize: 10 },
							],
							[
							...
							[
								{ text: "Berlaku mulai", fontSize: 10 },
								{
									text: `: ${dayjs(surat?.berlaku_dari)
										.locale("id")
										.format("DD MMMM  YYYY")} s/d ${dayjs(surat?.berlaku_sampai)
										.locale("id")
										.format("DD MMMM  YYYY")}`,
									fontSize: 10,
								},
