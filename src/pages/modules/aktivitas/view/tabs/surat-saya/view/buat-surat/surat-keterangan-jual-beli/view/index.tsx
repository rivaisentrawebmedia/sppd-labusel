...
import { FormInformasiPihakPertama } from "./FormInformasiPihakPertama";
import { FormInformasiPihakKedua } from "./FormInformasiPihakKedua";
import { FormInformasiBarang } from "./FormInformasoBarang";

export function FormSuratKeteranganJualBeli() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormInformasiPihakPertama disabled={disabled} form={form} />
					<FormInformasiPihakKedua disabled={disabled} form={form} />
					<FormInformasiBarang disabled={disabled} form={form} />
