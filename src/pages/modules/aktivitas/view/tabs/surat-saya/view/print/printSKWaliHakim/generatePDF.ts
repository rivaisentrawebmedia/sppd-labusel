...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
			...
			{
				text: `Yang namanya tersebut di atas memang benar warga kami yang akan menikah di ${profil_desa?.Kecamatan} Kabupaten ${profil_desa?.Kabupaten}. Berhubung orang tersebut tidak memiliki Wali Nasab, kami mohon dengan hormat Bapak Kepala KUA ${profil_desa?.Kecamatan} supaya berkenan menjadi Wali.`,
				fontSize: 10,
				margin: [0, 0, 0, 5],
			},
			{
