...
import { FormKepemilikanTanah } from "./FormKepemilikanTanah";
import { FormBatasTanah } from "./FormBatasTanah";
import { FormInformasiTambahan } from "../../FormInformasiTambahan";
import { FormWargaDesa } from "../../FormWargaDesa";

export function FormSuratKeteranganKepemilikanTanah() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormKepemilikanTanah disabled={disabled} form={form} />
					<FormBatasTanah disabled={disabled} form={form} />
