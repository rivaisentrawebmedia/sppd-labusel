...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
			...
			// 5️⃣ Isi penutup
			{
				text: `Adalah benar warga ${profil_desa?.nama_organisasi} Kecamatan ${profil_desa?.Kecamatan} Kabupaten ${profil_desa?.Kabupaten} dan berdasarkan keterangan yang kami terima, benar bahwa yang bersangkutan tergolong pada keluarga yang tidak mampu.`,
				fontSize: 10,
				margin: [0, 0, 0, 10],
			},
			{
				text: `Surat Keterangan Tidak Mampu ini diberikan ${surat?.keperluan}`,
				fontSize: 10,
				margin: [0, 0, 0, 10],
			},
			{
				text: `Demikian Surat Keterangan Tidak Mampu ini dibuat dan diberikan kepada yang bersangkutan untuk dipergunakan sebagaimana mestinya.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
