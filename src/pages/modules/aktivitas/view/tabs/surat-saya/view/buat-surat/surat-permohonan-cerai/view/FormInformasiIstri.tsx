...
export function FormInformasiIstri({
	...
	const nik = form.watch("nik_istri");
			...
			<div className="flex flex-col gap-4  border shadow  bg-white rounded-md p-4">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
					<SelectInput
						...
						onChange={(e) => {
							...
							form.setValue("nama_istri", selected?.nama_warga);
							form.setValue("nik_istri", selected?.nik);
							form.setValue("tempat_lahir_istri", selected?.tempat_lahir);
							form.setValue(
								"tanggal_lahir_istri",
							...
							form.setValue("agama_id_istri", selected?.agama_id);
							form.setValue("pekerjaan_istri", selected?.pekerjaan);
							form.setValue("alamat_istri", selected?.alamat);
						}}
					/>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
					<TextAreaInput
						...
						isRow
						label="Sebab Cerai"
						placeholder="Masukkan sebab cerai"
					/>
				</div>
			</div>
		</>
