...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
				...
				table: {
					...
					body: [
						...
						[
							...
							{ text: `: ${surat?.disahkan_oleh}`, fontSize: 10 },
						],
					],
				},
				layout: "noBorders",
			...
			{
				text: `Menerangkan dengan sebenarnya bahwa yang bernama:`,
				fontSize: 10,
				margin: [0, 0, 0, 10],
			},
			...
			{
				text: [
					`Dengan ini menerangkan bahwa nama tersebut adalah benar penduduk ${profilDesa?.nama_organisasi} Kecamatan ${profilDesa?.Kecamatan} Kabupaten ${profilDesa?.Kabupaten} Provinsi ${profilDesa?.Provinsi} `,
					{ text: "BELUM PERNAH MENIKAH", bold: true },
				],
				fontSize: 10,
				margin: [0, 0, 0, 5],
			},
			{
				text: `Demikian surat keterangan ini dibuat dengan sebenarna agar dapat dipergunakan seperlunya. Atas perhatiannya kami ucapkan terimakasih.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
