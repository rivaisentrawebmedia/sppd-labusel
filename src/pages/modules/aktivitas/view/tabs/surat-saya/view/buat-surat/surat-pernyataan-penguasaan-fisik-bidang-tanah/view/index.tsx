...
import { FormInformasiPemohon } from "./FormInformasiPemohon";
import { FormInformasiBidangTanah } from "./FormInformasiBidangTanah";
import { FormInformasiBatasTanah } from "./FormInformasiBatasTanah";
import { FormInformasiSaksi1 } from "./FormInformasiSaksi1";
import { FormInformasiSaksi2 } from "./FormInformasiSaksi2";

export function FormSuratPernyataanPenguasaanFisikBidangTanah() {
	...
	return (
		<>
			<Form {...form}>
				...
				>
					<FormInformasiPemohon disabled={disabled} form={form} />
					<FormInformasiBidangTanah disabled={disabled} form={form} />
					<FormInformasiBatasTanah disabled={disabled} form={form} />
					<FormInformasiSaksi1 disabled={disabled} form={form} />
					<FormInformasiSaksi2 disabled={disabled} form={form} />
