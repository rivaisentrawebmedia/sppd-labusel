...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
			...
			{
				table: {
					widths: ["25%", "75%"], // lebar kolom kiri & kanan
					body: [
						[
				...
				layout: "noBorders", // opsional: hilangkan garis table
				margin: [20, 0, 0, 10], // opsional: padding mirip pl-32
			},
			// 5️⃣ Isi penutup
			{
				text: `Berdasarkan data yang ada dan keterangan dari yang bersangkutan, diketahui bahwa yang bersangkutan akan melakukan perpindahan domisili dengan rincian sebagai berikut:`,
				fontSize: 10,
				margin: [0, 0, 0, 10],
			},
			{
				table: {
					...
					body: [
						[
							{ text: "Alasan Pindah", fontSize: 10 },
							{ text: `: ${surat?.alasan_pindah || ""}`, fontSize: 10 },
						],
						[
							{ text: "Alamat Pindah", fontSize: 10 },
							{ text: `: ${surat?.alamat_pindah || ""}`, fontSize: 10 },
						],
						[
							{ text: "Jumlah Anggota", fontSize: 10 },
							{ text: `: ${surat?.jumlah_anggota || ""} orang`, fontSize: 10 },
						],
					],
				},
				layout: "noBorders",
				margin: [20, 0, 0, 10], // mirip pl-32 dan gap-4
			},
			{
				text: `Surat Pengantar Pindah Domisili ini diberikan ${surat?.keperluan}`,
				fontSize: 10,
				margin: [0, 0, 0, 10],
			},
			{
				text: ` Demikian Surat Pengantar Domisili ini dibuat dan diberikan kepada yang bersangkutan untuk dipergunakan sebagaimana mestinya.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
