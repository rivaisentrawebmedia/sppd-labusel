...
import { FormPemberiIzin } from "./FormPemberiIzin";
import { FormYangDiberiIzin } from "./FormYangDiberiIzin";
import { FormInformasiPerizinan } from "./FormInformasiPerizinan";

export function FormSuratKeteranganIzinOrtu() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormPemberiIzin disabled={disabled} form={form} />
					<FormYangDiberiIzin disabled={disabled} form={form} />
					<FormInformasiPerizinan disabled={disabled} form={form} />
