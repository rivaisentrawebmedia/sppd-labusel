...
export const ResolverSurat = z.object({
	...
	ciri: z.string({ message: "Ciri wajib diisi" }),
	tempat_kehilangan: z.string({ message: "Tempat kehilangan wajib diisi" }),
	waktu_kehilangan: z.string({ message: "Waktu kehilangan wajib diisi" }),
