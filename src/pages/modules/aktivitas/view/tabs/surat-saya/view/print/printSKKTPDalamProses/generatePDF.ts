...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
					...
					table: {
						...
						body: [
							...
							[
								...
								{ text: `: ${surat?.kewarganegaraan || ""}`, fontSize: 10 },
							],
						],
					},
					layout: "noBorders",
			...
			// 3️⃣ Judul Data Ibu
			{
				text: `Orang tersebut di atas adalah benar-benar warga ${profil_desa?.nama_organisasi} yang saat ini Kartu Tanda Penduduk sedang dalam proses.`,
				margin: [0, 0, 0, 5],
				fontSize: 10,
			},
			{
				text: `Demikian surat keterangan ini dibuat dengan sesungguhnya agar dapat dipergunakan sebagaimana mestinya.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
