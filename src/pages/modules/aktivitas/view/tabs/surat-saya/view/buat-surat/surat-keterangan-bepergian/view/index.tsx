...
import { FormInformasiBepergian } from "./FormInformasiBepergian";
import { FormWargaDesa } from "../../FormWargaDesa";
import { FormInformasiTambahan } from "../../FormInformasiTambahan";

export function FormSuratKeteranganBepergian() {
		...
		<>
			<Form {...form}>
				...
				>
					...
					<FormInformasiBepergian disabled={disabled} form={form} />
