	...
	return {
		content: [
			...
			[
					...
					table: {
						...
						body: [
							[
								...
								{ text: `: ${surat?.nik_mendiang || ""}`, fontSize: 10 },
							],
							[
								{ text: "Nama", fontSize: 10 },
								{ text: `: ${surat?.nama_mendiang || ""}`, fontSize: 10 },
							],

							[
								{ text: "Tempat, Tanggal Lahir", fontSize: 10 },
								{
									text: `: ${surat?.tempat_lahir_mendiang}, ${
										surat?.tanggal_lahir_mendiang
											? dayjs(surat?.tanggal_lahir_mendiang)
													.locale("id")
													.format("DD MMMM YYYY")
											: ""
									}`,
							...
							[
								...
								{
									text: `: ${
										surat?.jenis_kelamin_mendiang === "L"
											? "Laki-laki"
											: "Perempuan"
									}`,
									fontSize: 10,
							...
							[
								...
								{ text: `: ${surat?.alamat_mendiang || ""}`, fontSize: 10 },
							],
						],
					},
					layout: "noBorders",
				...
				// 2️⃣ Judul Data Ayah
				{
					text: "Telah meninggal dunia pada:",
					margin: [0, 0, 0, 5],
					fontSize: 10,
				},
				{
					table: {
						...
						body: [
							[
								{ text: "Hari, tanggal", fontSize: 10 },
								{
									text: `: ${
										dayjs(surat?.tanggal_meninggal)
											.locale("id")
							...
							[
								...
								{ text: `: ${surat?.tempat_meninggal || ""}`, fontSize: 10 },
							],
							[
								{ text: "Penyebab Meninggal", fontSize: 10 },
								{
									text: `: ${surat?.sebab_meninggal || ""}`,
									fontSize: 10,
								},
							],
						],
				...
				// 3️⃣ Judul Data Ibu
				{
					text: "Keterangan ini berdasarkan laporan dari:",
					margin: [0, 0, 0, 5],
					fontSize: 10,
				},
				{
			...
			{
				text: `Surat Keterangan Kematian ini diberikan ${surat?.keperluan}`,
				fontSize: 10,
				margin: [0, 0, 0, 10],
			},
			{
				text: `Demikian Surat Keterangan Kematian ini dibuat dan diberikan kepada yang bersangkutan untuk dipergunakan sebagaimana mestinya.`,
				fontSize: 10,
				margin: [0, 0, 0, 20],
			},
