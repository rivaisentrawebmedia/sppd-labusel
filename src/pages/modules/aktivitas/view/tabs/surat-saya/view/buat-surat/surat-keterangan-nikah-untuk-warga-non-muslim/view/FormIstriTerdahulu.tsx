...
export function FormInformasiIstriTerdahulu({
	disabled,
	form,
}: {
		...
		<>
			<div className="flex flex-col gap-4  border shadow  bg-white rounded-md p-4">
				<p className="font-light uppercase underline underline-offset-4 text-primary">
					Informasi Istri Terdahulu
				</p>

				<div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
					<TextInput
						form={form}
						name="nik_istri_terdahulu"
						isDisabled={disabled}
						isRow
						label="NIK"
					...
					<TextInput
						form={form}
						name="nama_ayah_istri_terdahulu"
						isRow
						isDisabled={disabled}
						label="Nama Ayah"
						placeholder="Masukkan nama lengkap"
					...
					<TextInput
						form={form}
						name="tempat_lahir_istri_terdahulu"
						isRow
						isDisabled={disabled}
						label="Tempat Lahir"
					...
					<TextInput
						form={form}
						name="tanggal_lahir_istri_terdahulu"
						type="date"
						isRow
						isDisabled={disabled}
						label="Tanggal Lahir"
					...
					<SelectInput
						form={form}
						name="kewarganegaraan_istri_terdahulu"
						isDisabled={disabled}
						isRow
					...
					<TextInput
						form={form}
						name="pekerjaan_istri_terdahulu"
						isDisabled={disabled}
						label="Pekerjaan"
						isRow
					...
					<TextInput
						form={form}
						name="tempat_meninggal_istri_terdahulu"
						isDisabled={disabled}
						isRow
					...
					<TextInput
						form={form}
						name="tanggal_meninggal_istri_terdahulu"
						isDisabled={disabled}
						isRow
