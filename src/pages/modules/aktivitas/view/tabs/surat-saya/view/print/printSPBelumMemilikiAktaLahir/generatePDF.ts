...
export function generatePdfSurat(data: Surat) {
	...
	return {
		content: [
			...
			[
				{
					table: {
						...
						body: [
							...
							[
								{ text: "NIK / No. KTP Ayah", fontSize: 10 },
							...
							[
								{ text: "NIK / No. KTP Ibu", fontSize: 10 },
			...
			{
				text: `Adalah benar-benar warga ${profil_desa?.nama_organisasi} dan belum pernah memiliki Akta Kelahiran.`,
				fontSize: 10,
				margin: [0, 0, 0, 5],
			},
			{
